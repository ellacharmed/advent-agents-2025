...
- [x] Explore Google ADK and Agent Engine documentation
...
### Documentation
- [Google ADK: The Agent Development Kit (Python)](https://google.github.io/adk-docs/get-started/python/)
- [Vertex AI Agent Engine: Deploy an Agent in minutes](https://cloud.google.com/products/agent-builder?hl=en)
- [The Agent Starter Pack: E2E production-ready templates](https://github.com/GoogleCloudPlatform/agent-starter-pack)
